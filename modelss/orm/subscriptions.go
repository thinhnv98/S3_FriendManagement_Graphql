...
var SubscriptionWhere = struct {
	...
	RequestorID: whereHelperint64{field: "\"subscriptions\".\"requestor_id\""},
	TargetID:    whereHelperint64{field: "\"subscriptions\".\"target_id\""},
}
...
var (
	...
	subscriptionColumnsWithoutDefault = []string{"requestor_id", "target_id"}
...
func (q subscriptionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: failed to execute a one query for subscriptions")
	}
...
func (q subscriptionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to count subscriptions rows")
	}
...
func (q subscriptionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "orm: failed to check if subscriptions exists")
	}
...
func (o *Subscription) Requestor(mods ...qm.QueryMod) useremailQuery {
...
func (o *Subscription) Target(mods ...qm.QueryMod) useremailQuery {
	queryMods := []qm.QueryMod{
...
func (o *Subscription) SetRequestor(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Useremail) error {
	var err error
	if insert {
...
func (o *Subscription) SetTarget(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Useremail) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func FindSubscription(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Subscription, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: unable to select from subscriptions")
	}
...
func (o *Subscription) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no subscriptions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to insert into subscriptions")
	}
...
func (o *Subscription) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("orm: unable to update subscriptions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update subscriptions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by update for subscriptions")
	}
...
func (q subscriptionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all for subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected for subscriptions")
	}
...
func (o *Subscription) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no subscriptions provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("orm: unable to upsert subscriptions, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert subscriptions")
	}
...
func (o *Subscription) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by delete for subscriptions")
	}
...
func (q subscriptionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from subscriptions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by deleteall for subscriptions")
	}
...
func SubscriptionExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "orm: unable to check if subscriptions exists")
	}
