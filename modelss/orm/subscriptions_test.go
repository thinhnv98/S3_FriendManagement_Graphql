...
func testSubscriptionToOneUseremailUsingRequestor(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
...
func testSubscriptionToOneUseremailUsingTarget(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
...
func testSubscriptionToOneSetOpUseremailUsingRequestor(t *testing.T) {
	var err error
...
func testSubscriptionToOneSetOpUseremailUsingTarget(t *testing.T) {
	var err error
...
var (
	subscriptionDBTypes = map[string]string{`ID`: `bigint`, `RequestorID`: `bigint`, `TargetID`: `bigint`}
	_                   = bytes.MinRead
)
